...
try {
    ...
    const ticket = {
        ...
        /* =============================================
           ...
           IMPORTANTE:
           Debe coincidir exactamente con Firestore Rules.
        ============================================= */
    ...
    console.log(
        "Newsroom Portal: ticket público creado correctamente.",
        referencia.id
    );
    ...
    if (
        ...
        mensaje =
            "Firebase rechazó el ticket por las reglas de seguridad.";
    ...
    if (
        ...
        mensaje =
            "Firebase requiere una configuración adicional.";
